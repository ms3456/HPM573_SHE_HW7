...
class Cohort:
    ...
    # get percentage of patients survived beyond 5 years after simulating a cohort
    def get_perct_beyond5years(self):
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._fiveYearSurvivalProb=[] # list of five year survival probs for each simulated cohort
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            self._fiveYearSurvivalProb.append(cohort.get_perct_beyond5years())
